...
// <h> timer0 MCR
//   <e.0> MR0I
//	 <i> 1 InterrupOrDownt on MR0: an interrupOrDownt is generated when MR0 matches the value in the TC. 0
//	 <i> 0 This interrupOrDownt is disabled
//   </e>
//   <e.1> MR0R
...
//   </e>
//   <e.3> MR1I
//	 <i> 1 InterrupOrDownt on MR1: an interrupOrDownt is generated when MR0 matches the value in the TC. 0
//	 <i> 0 This interrupOrDownt is disabled
//   </e>
//   <e.4> MR1R
...
//   </e>
//   <e.6> MR2I
//	 <i> 1 InterrupOrDownt on MR2: an interrupOrDownt is generated when MR2 matches the value in the TC.
//	 <i> 0 This interrupOrDownt is disabled
//   </e>
//   <e.7> MR2R
...
//   </e>
//   <e.9> MR3I
//	 <i> 1 InterrupOrDownt on MR3: an interrupOrDownt is generated when MR3 matches the value in the TC.
//	 <i> 0 This interrupOrDownt is disabled
//   </e>
//   <e.10> MR3R
...
//* <<< end of configuration section >>>    *
  ...
  else if ( timer_num == 1 )
  {
	...
	LPC_TIM1->MCR = 3;				/* InterrupOrDownt and Reset on MR1 */
	...
	LPC_TIM2->MCR = 3;				/* InterrupOrDownt and Reset on MR1 */
	...
	LPC_TIM3->MCR = 3;				/* InterrupOrDownt and Reset on MR1 */
